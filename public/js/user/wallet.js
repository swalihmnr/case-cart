...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function showSuccessModal(amount) {
    Swal.fire({
      icon: "success",
      title:
        '<span style="font-size: 28px; font-weight: 600;">Payment Successful! 🎉</span>',
      html: `
      ...
      customClass: {
        ...
        confirmButton:
          "px-6 py-3 text-base font-medium rounded-lg shadow-md hover:shadow-lg transition-all duration-200",
        cancelButton:
          "px-6 py-3 text-base font-medium rounded-lg hover:bg-gray-100 transition-all duration-200",
      },
    }).then((result) => {
  ...
  function showFailureModal(errorMessage, amount) {
    Swal.fire({
      icon: "error",
      title:
        '<span style="font-size: 28px; font-weight: 600;">Payment Failed! 😟</span>',
      html: `
                <div style="text-align: center; padding: 10px;">
      ...
      customClass: {
        ...
        confirmButton:
          "px-6 py-3 text-base font-medium rounded-lg shadow-md hover:shadow-lg transition-all duration-200",
        cancelButton:
          "px-6 py-3 text-base font-medium rounded-lg hover:shadow-lg transition-all duration-200",
      },
    }).then((result) => {
      if (result.isConfirmed) {
  ...
  function showTimeoutModal(amount) {
    Swal.fire({
      icon: "info",
      title:
        '<span style="font-size: 28px; font-weight: 600;">Payment Cancelled! ✋</span>',
      html: `
        <div style="text-align: center; padding: 10px;">
