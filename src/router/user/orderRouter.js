...
router.post('/order/:id/payment-failed', userAuth, blockUser, orderController.markPaymentFailed);
router.patch('/order/:id/cancel-all', userAuth, blockUser,orderController.cancelWholeOrder);
