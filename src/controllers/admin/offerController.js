...
const postOfferAdd = async (req, res) => {
  try {
    ...
    const { title, description, offerType, offerValue, maximumDiscountValue, applicableOn, startDate, endDate, productIds, categoryIds } = req.body;
    if (
      !title ||
      !offerType ||
      !offerValue ||
...
const postEditOffer = async (req, res) => {
  try {
    ...
    const { offerId, title, description, offerType, offerValue, maximumDiscountValue, applicableOn, startDate, endDate, productIds, categoryIds, status } = req.body;
    console.log(offerId)
